...
args = {
    ...
    "q_ansatz": "sim_circ_19",  # options: "None" for CV and classical , for DV: "alternating_layer_tdcnot",  sim_circ_13_half, sim_circ_13 , sim_circ_14_half, sim_circ_14 , sim_circ_15 ,sim_circ_19
    "mode": mode,
    "activation": "tanh",  
